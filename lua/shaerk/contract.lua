...
function M.instructions(tmp)
  return table.concat({
    ...
    "  - Keep every comment already present in the target, verbatim and in the",
    "    same order. They are the spec: write the code each one describes",
    "    directly under it. Never delete, reword, or merge them.",
    "",
